...
## path to the gene summary file (required)
gene_summary = file.path("./GD2_72h_v_Baseline.gene_summary.tx")
gene_summary = file.path("C:/Users/thephillipslab/Desktop/GD2_v_CD19_72h_edgeR.median.gene_summary.txt")
## path to the sgRNA summary file (optional)
sgRNA_summary = file.path("./EPZ_total_d45.sgrna_summary.txt")
sgRNA_summary = file.path("C:/Users/thephillipslab/Desktop/GD2_48h_v_Baseline_edgeR.median.sgrna_summary.txt")

# Run FluteRRA with only gene summary file
FluteRRA(gene_summary, 
         proj="GD2_v_CD19_72h", # Prefix of output, can be your project name
...
## path to the gene summary file (required)
gene_summary = file.path("./CD19_48h_v_Baseline_noCtrlgRNA.gene_summary.txt")
...
pdf("./MAGeCKFlute_GD2_48h_v_Baseline/rankplotScatter.pdf")
p1
dev.off()
